      ...
      <div className="container mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:pr-12">
            ...
            {/* Primary Button */}
            <button 
              className="bg-black hover:bg-gray-700 text-white font-bold py-3 px-8 
            ...
            <div key={currentRoom.id} className="relative">
                ...
                <div className="absolute bottom-6 left-6 bg-white/90 p-4 md:p-6 rounded-lg max-w-[250px]">
                    ...
                    <button 
                        ...
                        className="absolute -right-12 bottom-0 p-4 bg-black hover:bg-gray-700 transition duration-300"
                    >
