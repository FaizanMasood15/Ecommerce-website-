    ...
    if (cartItems.length === 0) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4 px-4">
                ...
                <Link
                    to="/shop"
                    className="mt-2 bg-black text-white px-8 py-3 font-semibold hover:bg-gray-700 transition"
                >
                    Continue Shopping
                </Link>
            </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                            ...
                            <button
                                ...
                                className="mt-6 w-full bg-black hover:bg-gray-700 text-white font-bold py-3 px-4 rounded-lg transition flex items-center justify-center gap-2"
                            >
