            ...
            <div className="bg-white p-8 md:p-12 rounded-lg shadow-md w-full max-w-md">
                ...
                <form onSubmit={submitHandler} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-stone-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 transition-colors mt-6"
                    >
