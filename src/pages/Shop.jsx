        ...
        <div className="container mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="hidden sm:flex justify-center space-x-4 mt-10">
            {[...Array(currentTotalPages)].map((_, index) => {
              ...
              <button
                ...
                className={`${currentPage === pageNumber
                    ...
                    : 'bg-white text-gray-900 hover:bg-gray-700 hover:text-white border-gray-300'
            ...
            {currentPage < currentTotalPages && (
              <button
                onClick={() => handlePageChange(currentPage + 1)}
                className="bg-white border border-gray-300 text-gray-900 text-sm tracking-[0.08em] uppercase font-semibold py-3 px-5 hover:bg-gray-700 hover:text-white transition duration-200"
              >
                Next
              </button>
            )}
